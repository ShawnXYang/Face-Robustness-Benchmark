# reference: https://github.com/MuggleWang/CosFace_pytorch/blob/master/net.py
import torch
...
class CosFace(FaceModel):
	def __init__(self, **kwargs):
		net = sphere()
		url = 'http://ml.cs.tsinghua.edu.cn/~dingcheng/ckpts/cosface.pth'
		channel = 'rgb'
		FaceModel.__init__(
			self,
			net=net,
