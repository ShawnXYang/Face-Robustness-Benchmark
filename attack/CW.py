...
from attack.utils import atanh
import torch
...
__all__ = ['CW']
class CW(Attack):
    def __init__(self, model, goal, distance_metric, threshold, iteration=100, search_steps=2, binsearch_steps=10, confidence=1e-3, learning_rate=1e-3, c=1e-3):
    ...
    def batch_attack(self, xs, ys, **kwargs):
        ...
        for _ in range(self.search_steps):
            ...
            for _ in range(self.iteration):
                ...
                similarities = torch.sum(logits * ys, dim=1)
