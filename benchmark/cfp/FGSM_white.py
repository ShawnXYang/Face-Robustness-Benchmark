...
from benchmark.cfp.utils import run_white, binsearch_basic
import attack
...
def main():
    ...
    config = {
        ...
        'threshold': threshold_cfp[args.model]['cos'],
        'steps': args.steps,
    ...
    run_white(path, Attacker, model, args, threshold_cfp[args.model]['cos'])
